	...
	<body>
		<div>
			<div style="margin-bottom: 20px;margin-left: 40px;">
				...
				<input class="easyui-textbox" data-options="prompt:'单位名称'" style="width:180px" id="name"></input>
				<input class="easyui-textbox" data-options="prompt:'单位编码'" style="width:180px" id="code"></input>
		...
		<div id="info_win"></div>
		<script type="text/javascript" src="/scripts/model/ItemSupplierList.js?t=1111300"></script>
